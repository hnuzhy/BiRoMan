...
python skills/pourClosedLoopV1.py --task_name pouring_full_stage --bottle_id 1 --mugcup_id 1 --test_id 100
python skills/pourClosedLoopV1.py --task_name pouring_full_stage --no_interaction --bottle_id 1 --mugcup_id 1 --test_id 100
