...
# c=kingfisher.connect("192.168.11.57")   # connect the camera (for dual-arm aubo-i5)
c=kingfisher.connect("192.168.11.58")   # connect the camera (for dual-arm rokae-CR7)
# c=kingfisher.connect("192.168.11.60")   # connect the camera (for dual-arm SongLing)
